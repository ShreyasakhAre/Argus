...
export function ProfileSection() {
  ...
  // Debug: Log the actual user role
  console.log('ProfileSection - User role:', user?.role);
    ...
    <>
      ...
      <div className="flex items-center gap-3 p-3 border-t border-zinc-800">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-xs text-zinc-400 truncate break-words">{user.email || 'No email'}</p>
        </div>
        <Dialog open={isProfileOpen} onOpenChange={setIsProfileOpen}>
          ...
          <DialogContent className="max-w-[500px] w-full mx-auto max-h-[90vh] overflow-y-auto overflow-x-hidden rounded-xl bg-zinc-900 border-zinc-800">
            <DialogHeader>
                  ...
                  <div className="p-4 border border-zinc-700 rounded-lg">
                    <div className="flex flex-col gap-2">
                      ...
                      <div className="flex flex-wrap gap-2">
                        <ChangePasswordModal 
                          trigger={
                            <Button variant="outline" size="sm" className="flex-1 min-w-[120px] border-zinc-700 text-zinc-300 hover:bg-zinc-800">
                        ...
                        <Button 
                          ...
                          className="flex-1 min-w-[120px] border-zinc-700 text-zinc-300 hover:bg-zinc-800"
                        >
